        ...
        while not exit_flag.is_set() and not cfg_reload.is_set():
            ...
            if not action_q.empty():
                ...
                if line_type == "location":
                    ...
                    system_q.put(eqa_struct.message(eqa_settings.eqa_time(),
                                                    'system', 'loc', 'null', loc))
                elif line_type == "direction":
                    direction = check_line_list[-1].replace('.', '')
                    system_q.put(eqa_struct.message(eqa_settings.eqa_time(),
                                                    'system', 'direction', 'null', direction))
                elif line_type.startswith("you_afk"):
                    if line_type == "you_afk_on":
                        display_q.put(eqa_struct.display(eqa_settings.eqa_time(),
                                                         'event', 'events', 'You are now AFK'))
                        system_q.put(eqa_struct.message(eqa_settings.eqa_time(),
                                                        'system', 'afk', 'null', 'true'))
                    elif line_type == "you_afk_off":
                        display_q.put(eqa_struct.display(eqa_settings.eqa_time(),
                                                         'event', 'events', 'You are no longer AFK'))
                        system_q.put(eqa_struct.message(eqa_settings.eqa_time(),
                                                        'system', 'afk', 'null', 'false'))
                    ...
                    display_q.put(eqa_struct.display(eqa_settings.eqa_time(),
                                                     'update', 'zone', current_zone))
                    system_q.put(eqa_struct.message(eqa_settings.eqa_time(),
                                                    'system', 'zone', 'null', current_zone))
