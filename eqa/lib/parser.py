...
def check_spell_specific(line):
    ...
    try:
        if re.fullmatch(r"^[a-zA-Z`\s]+ experiences a quickening\.$", line) is not None:
            ...
            return "spell_see_invis_you_off"
            ...
            return "spell_buff_charisma_you_off"
            ...
            return "spell_holy_guard_you_off"
            ...
            return "spell_dot_disease_other_on"
            ...
            return "spell_dot_disease_you_on"
            ...
            return "spell_dot_disease_you_off"
            ...
            return "spell_buff_agility_other_on"
            ...
            return "spell_buff_agility_you_off"
            ...
            return "spell_bard_cancel_you_on"
            ...
            return "spell_faction_increase_other_on"
            ...
            return "spell_faction_increase_you_on"
            ...
            return "spell_faction_increase_you_off"
            ...
            return "spell_low_necro_mana_regen_other_on"
            ...
            return "spell_misc_feel_better_you_off"
            ...
            re.fullmatch(r"^The Call of Sky fills your weapons with power\.\.$", line)
            is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+ is knocked backwards by a concussion of air\.$", line
            )
            is not None
        ):
        ...
        elif re.fullmatch(r"^You feel your aggression subside\.$", line) is not None:
        ...
        elif re.fullmatch(r"^Your body aches as your mind clears\.$", line) is not None:
            ...
            re.fullmatch(r"^You are filled by the spirit of water\.$", line) is not None
        ):
        ...
        elif re.fullmatch(r"^You are pelted by hailstones\.$", line) is not None:
            ...
            re.fullmatch(r"^The blood stops flowing in your veins\.$", line) is not None
        ):
            ...
            re.fullmatch(
                r"^Your legs lock in pain as you choke on the noxious poison\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(r"^You experience chaotic weightlessness\.$", line) is not None
        ):
            ...
            re.fullmatch(r"^Your world goes mad as chaos flows through you\.$", line)
            is not None
        ):
        ...
        elif re.fullmatch(r"^You feel your skin ignite and char\.$", line) is not None:
            ...
            re.fullmatch(r"^The chill of unlife wracks your body\.$", line) is not None
        ):
        ...
        elif re.fullmatch(r"^You are wracked by chilling poison\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are blasted with chlorophyll\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are immolated by raging energy\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are surrounded by a summer haze\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are surrounded by a winter haze\.$", line) is not None:
            ...
            re.fullmatch(r"^A soft breeze slips through your mind\.$", line) is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+ has been poisoned, and begins to look dizzy\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(
                r"^You have been poisoned\.  You begin to feel very dizzy\.$", line
            )
            is not None
        ):
        ...
        elif re.fullmatch(r"^You feel your skin freeze\.$", line) is not None:
            ...
            re.fullmatch(
                r"^The cogs in your armor spin faster and faster and faster\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(
                r"^A song of inspiration fills your weapon arm with strength\.$", line
            )
            is not None
        ):
        ...
        elif re.fullmatch(r"^You stagger from a blow to the head\.$", line) is not None:
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+ is consumed by the raging spirits of the land\.$", line
            )
            is not None
        ):
        ...
        elif re.fullmatch(r"^You feel your health begin to drain\.$", line) is not None:
            return "spell_dark_pact_you_on"
        elif (
            re.fullmatch(
                r"^[a-zA-Z`\s]+ staggers as the light of dawn washes over it\.$", line
            )
            is not None
        ):
            return "spell_dawncall_other_on"
        elif (
            re.fullmatch(r"^You stagger as the light of dawn washes over you\.$", line)
            is not None
        ):
        ...
        elif re.fullmatch(r"^A flickering shield surrounds you\.$", line) is not None:
            ...
            re.fullmatch(r"^You feel part of your mind melt away\.$", line) is not None
        ):
        ...
        elif re.fullmatch(r"^You have been diseased\.$", line) is not None:
        ...
        elif re.fullmatch(r"^Your stomach begins to cramp\.$", line) is not None:
            ...
            re.fullmatch(r"^You breathe out a cloud of corruption\.$", line) is not None
        ):
            ...
            re.fullmatch(r"^You are surrounded by an aura of Divine Favor\.\.$", line)
            is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+ feels the watchful eyes of the gods upon them\.$", line
            )
            is not None
        ):
            return "spell_divine_intervention_other_on"
        elif (
            re.fullmatch(r"^You feel the watchful eyes of the gods upon you\.$", line)
            is not None
        ):
        ...
        elif re.fullmatch(r"^You invoke the presence of the gods\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are bathed in a divine light\.$", line) is not None:
            ...
            re.fullmatch(r"^You have been struck by a surge of Divine Might\.$", line)
            is not None
        ):
            ...
            re.fullmatch(r"^A flame of divine purpose compels you\.$", line) is not None
        ):
            ...
            re.fullmatch(r"^You feel dizzy as poison seeps through your skin\.$", line)
            is not None
        ):
            ...
            re.fullmatch(r"^You are encased in a cone of icy rage.$", line) is not None
        ):
        ...
        elif re.fullmatch(r"^You are caught in a torrent of fire\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You feel the ground shake\.$", line) is not None:
            ...
            re.fullmatch(r"^Your body is electrified as lightning strikes you\.$", line)
            is not None
        ):
            ...
            re.fullmatch(r"^You feel protected from fire and ice\.$", line) is not None
        ):
            ...
            re.fullmatch(
                r"^You feel an aura of elemental protection surrounding you\.$", line
            )
            is not None
        ):
        ...
        elif re.fullmatch(r"^You are stunned with reverent awe\.$", line) is not None:
        ...
        elif re.fullmatch(r"^Your feet become entwined\.$", line) is not None:
        ...
        elif re.fullmatch(r"^Your mind reels as your body heals\.$", line) is not None:
            return "spell_envenomed_heal_you_on"
        elif re.fullmatch(r"^You feel your essence drain away\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You feel your skin burn with poison\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You feel your life force drain away\.$", line) is not None:
            ...
            re.fullmatch(
                r"^You feel your mind fuzz as poison spreads through your body\.$", line
            )
            is not None
        ):
        ...
        elif re.fullmatch(r"^You are enveloped in blazing energy\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are immolated in flame\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are blasted by blazing winds\.$", line) is not None:
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+\'s skin blisters as fire rains down from above\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(r"^Your skin blisters as fire rains down from above\.$", line)
            is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+ has been struck by the shocking Fist of Karana\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(r"^You are surrounded by an outline of cold flame\.$", line)
            is not None
        ):
            ...
            re.fullmatch(r"^Your body is engulfed in a jet of flames\.$", line)
            is not None
        ):
        ...
        elif re.fullmatch(r"^Your flesh begins to rot\.$", line) is not None:
        ...
        elif re.fullmatch(r"^A flurry of attacks assaults you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You have been force struck\.$", line) is not None:
            ...
            re.fullmatch(r"^You are blasted by energy laden winds\.$", line) is not None
        ):
        ...
        elif re.fullmatch(r"^You exhale a freezing cone of cold\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are chilled by a bolt of frost\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are blasted by freezing winds\.$", line) is not None:
            ...
            re.fullmatch(r"^You feel the blessing of ancient Coldain heroes\.$", line)
            is not None
        ):
        ...
        elif re.fullmatch(r"^You feel a static pulse engulf you\.$", line) is not None:
            ...
            re.fullmatch(r"^You are covered by a sticky substance\.$", line) is not None
        ):
            ...
            re.fullmatch(r"^Your skin blisters as poison rains down on you\.$", line)
            is not None
        ):
            ...
            re.fullmatch(r"^Your mind fills with horrific visions\.$", line) is not None
        ):
            ...
            re.fullmatch(r"^A small piece of your soul is sucked out of you\.$", line)
            is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+ has been mesmerized by the Glamour of Kintaz\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(
                r"^The protective presence of a guardian spirit surrounds you\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(r"^A magical hammer appears in your hand\.$", line) is not None
        ):
            ...
            re.fullmatch(r"^The voice of the Harpy drains your will to fight\.$", line)
            is not None
        ):
            ...
            re.fullmatch(r"^You check your plant for dead leaves\.$", line) is not None
        ):
        ...
        elif re.fullmatch(r"^Your heartbeat becomes irregular\.$", line) is not None:
            ...
            re.fullmatch(r"^You feel the holy wrath of the heavens upon you\.\.$", line)
            is not None
        ):
        ...
        elif re.fullmatch(r"^Your soul is assaulted by the ages\.$", line) is not None:
        ...
        elif re.fullmatch(r"^Your body is rent by freezing ice\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is struck down by Solist's spear of ice\.$", line) is not None:
            return "spell_ice_spear_of_solist_other_on"
        elif re.fullmatch(r"^Solist's spear of ice strikes you down\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by blazing flames\.$", line) is not None:
            return "spell_immolate_other_on"
        elif re.fullmatch(r"^You are surrounded by blazing flames\.$", line) is not None:
        ...
        elif re.fullmatch(r"^Your flesh is seared from your bones\.$", line) is not None:
            return "spell_immolating_breath_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ exhales a cloud of flame\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ shrieks as their bones are set ablaze\.$", line) is not None:
            return "spell_incinerate_bones_other_on"
        elif re.fullmatch(r"^You shriek as your bones are ablaze\.$", line) is not None:
        ...
        elif re.fullmatch(r"^The bile wells up in your throat\.$", line) is not None:
            return "spell_infectious_cloud_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ burns within the inferno of Al'Kabor\.$", line) is not None:
            return "spell_inferno_of_alkabor_other_on"
        elif re.fullmatch(r"^You burn within the inferno of Al'Kabor\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You feel a fever settle upon you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^This is a BUG\.  Please report it to a GM\.$", line) is not None:
            return "spell_inspire_fear_you_cast"
            # return "spell_invoke_fear_you_cast"
        elif re.fullmatch(r"^You feel gravity reverse\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ vanishes amidst the sound of whirrs and clicks\.$", line) is not None:
            return "spell_invisibility_cloak_other_on"
        elif re.fullmatch(r"^You vanish amidst the sound of whirrs and clicks\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by an aura which shimmers and then fades away\.$", line) is not None:
        ...
        elif re.fullmatch(r"^A static pulse slams through you\.$", line) is not None:
            return "spell_jylls_static_pulse_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is ashed by an intense wave of heat\.$", line) is not None:
            return "spell_jylls_wave_of_heat_other_on"
        elif re.fullmatch(r"^A wave of heat screams through you\.$", line) is not None:
            return "spell_jylls_wave_of_heat_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is torn by a zephyr of ice\.$", line) is not None:
            return "spell_jylls_zephyr_of_ice_other_on"
        elif re.fullmatch(r"^A zephyr of ice tears through you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin begins to steam\.$", line) is not None:
        ...
        elif re.fullmatch(r"^A massive force knocks you backwards\.$", line) is not None:
            return "spell_knockback_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ sends forth a burst of energy\.$", line) is not None:
            return "spell_knockback_other_cast"
        elif re.fullmatch(r"^You send forth a burst of energy\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is bound by strands of solid music\.$", line) is not None:
            return "spell_largos_absonant_binding_other_on"
            # return "spell_largos_melodic_binding_other_on"
        elif re.fullmatch(r"^Strands of solid music bind your body\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is burned by the basilisk\'s firey breath\.$", line) is not None:
            return "spell_lava_breath_other_on"
        elif re.fullmatch(r"^You are seared by the basilisk's lava breath\.\.$", line) is not None:
            return "spell_lava_breath_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ pales\.$", line) is not None:
            return "spell_leach_other_on"
        elif re.fullmatch(r"^You feel your blood begin to leach away\.$", line) is not None:
            return "spell_leach_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin looks like leather\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a thorny barrier\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are surrounded by a thorny barrier\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s feet leave the ground\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s body spasms as the lightning bolt arcs through them\.$", line) is not None:
            return "spell_lightning_bolt_other_on"
        elif re.fullmatch(r"^Your body spasms as the lightning bolt arcs through you\.$", line) is not None:
            return "spell_lightning_bolt_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is showered by sparks of lightning\.$", line) is not None:
            return "spell_lightning_breath_other_on"
        elif re.fullmatch(r"^The drake's breath showers you in painful sparks\.$", line) is not None:
            return "spell_lightning_breath_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin ignites\.\.$", line) is not None:
            return "spell_lightning_shock_other_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin blisters as lightning rains down from above\.$", line) is not None:
            return "spell_lightning_storm_other_on"
        elif re.fullmatch(r"^Your skin blisters as lightning rains down from above\.$", line) is not None:
        ...
        elif re.fullmatch(r"^Your body spasms as you are struck by lightning\.$", line) is not None:
            return "spell_lightning_strike_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s body begins to smoke\.$", line) is not None:
            return "spell_liquid_silver_ii_other_on"
            # return "spell_liquid_silver_iii_other_on"
        elif re.fullmatch(r"^The liquid silver burns your body\.$", line) is not None:
        ...
        elif re.fullmatch(r"^Your body feels frail as poison seeps in to you\.$", line) is not None:
            return "spell_lower_resists_i_you_on"
        elif re.fullmatch(r"^Your body feels frail as poison seeps into your skin\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ succumbs to the lure of flame\.$", line) is not None:
            return "spell_lure_of_flame_other_on"
        elif re.fullmatch(r"^You succumb to the lure of flame\.$", line) is not None:
            return "spell_lure_of_flame_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ succumbs to the lure of frost\.$", line) is not None:
            return "spell_lure_of_frost_other_on"
        elif re.fullmatch(r"^You succumb to the lure of frost\.$", line) is not None:
            return "spell_lure_of_frost_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ succumbs to the lure of ice\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ succumbs to the lure of lightning\.$", line) is not None:
            return "spell_lure_of_lightning_other_on"
        elif re.fullmatch(r"^You succumb to the lure of lightning\.$", line) is not None:
            return "spell_lure_of_lightning_you_on"
        elif re.fullmatch(r"^Long forgotten knowledge sifts through your mind\.$", line) is not None:
            return "spell_lyssas_cataloging_libretto_you_on"
        elif re.fullmatch(r"^A tune pervades your mind and beckons you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s eyes are covered by notes of solid music\.$", line) is not None:
        ...
        elif re.fullmatch(r"^Music floods your mind and sharpens your sight\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ looks very uncomfortable\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is caught in a malevolent grasp\.$", line) is not None:
            return "spell_malevolent_grasp_other_on"
        elif re.fullmatch(r"^You are caught in a malevolent grasp\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You feel your life draining into your mind\.$", line) is not None:
            return "spell_mana_conversion_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by orbs of chaotic mana\.$", line) is not None:
            return "spell_mana_flare_other_on"
        elif re.fullmatch(r"^Orbs of chaotic mana swirl around you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You feel your mental energies slip away\.$", line) is not None:
            return "spell_mana_sieve_you_on"
        elif re.fullmatch(r"^Your mind clouds\.$", line) is not None:
            return "spell_mana_sink_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin is slicked by a silvery glow\.$", line) is not None:
            return "spell_manasink_other_on"
        elif re.fullmatch(r"^A silvery force slicks your skin\.$", line) is not None:
            return "spell_manasink_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin gleams with an incandescent glow\.$", line) is not None:
            return "spell_manaskin_other_on"
        elif re.fullmatch(r"^Your skin gleams with an incandescent glow\.$", line) is not None:
            return "spell_manaskin_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin numbs as deadly mana rains down from above\.$", line) is not None:
            return "spell_manastorm_other_on"
        elif re.fullmatch(r"^Your skin numbs as deadly mana rains down from above\.$", line) is not None:
            return "spell_manastorm_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s muscles fill with maniacal strength\.$", line) is not None:
            return "spell_maniacal_strength_other_on"
        elif re.fullmatch(r"^You are filled with maniacal strength\.$", line) is not None:
            return "spell_maniacal_strength_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ begins to shape the elements\.$", line) is not None:
            return "spell_manifest_elements_other_cast"
        elif re.fullmatch(r"^By your will the elements begin to take shape\.$", line) is not None:
            return "spell_manifest_elements_you_cast"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s stinger gleams with poison\.$", line) is not None:
            return "spell_manticore_poison_other_cast"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin gleams with a pure aura\.$", line) is not None:
            return "spell_mark_of_karn_other_on"
        elif re.fullmatch(r"^Your skin gleams with a pure aura\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is swept away by a mellifluous melody\.$", line) is not None:
            return "spell_melanies_mellifluous_motion_other_on"
        elif re.fullmatch(r"^A mellifluous melody sweeps you away\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is covered by a cloud of pain\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a translucent shield\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ summons a familiar of the Mistwalker\.$", line) is not None:
            return "spell_mistwalker_other_on"
        elif re.fullmatch(r"^You summon a familiar of the Mistwalker\.$", line) is not None:
            return "spell_mistwalker_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ modulates\.$", line) is not None:
            return "spell_modulation_other_on"
        elif re.fullmatch(r"^You modulate\.$", line) is not None:
            return "spell_modulation_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ begins to move with mortal deftness\.$", line) is not None:
            return "spell_mortal_deftness_other_on"
        elif re.fullmatch(r"^Your muscles move with mortal deftness\.$", line) is not None:
        ...
        elif re.fullmatch(r"^Your legs spasm as poison seeps through your veins\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s armor movements are sharpened by an injection of mana energy$", line) is not None:
            return "spell_mystic_precision_other_on"
        elif re.fullmatch(r"^A precise infusion of mana energy sharpens your armors movement$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is cloaked in a shimmer of glowing symbols\.$", line) is not None:
            return "spell_naltrons_mark_other_on"
        elif re.fullmatch(r"^A mystic symbol flashes before your eyes\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ summons a spirit of nature\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is assaulted by the wrath of nature\.$", line) is not None:
            return "spell_natures_holy_wrath_other_on"
        elif re.fullmatch(r"^You feel the holy wrath of nature upon you\.$", line) is not None:
            return "spell_natures_holy_wrath_you_on"
        elif re.fullmatch(r"^The melody of nature strengthens your arms\.\.$", line) is not None:
            return "spell_natures_melody_other_on"
        elif re.fullmatch(r"^The melody of nature leaves your arms\.$", line) is not None:
            return "spell_natures_melody_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ has been struck down by the wrath of nature\.$", line) is not None:
            return "spell_natures_wrath_other_on"
        elif re.fullmatch(r"^You have been struck down by the wrath of nature\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You feel an aura of protection engulf you.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s image shifts out of focus\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ reels in pain and loses concentration\.$", line) is not None:
            return "spell_occlusion_of_sound_other_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ lets loose a piercing blast\.$", line) is not None:
            return "spell_occlusion_of_sound_other_cast"
        elif re.fullmatch(r"^You throw your head back and let loose a piercing blast\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ begins to spin from one hundred blows\.$", line) is not None:
            return "spell_one_hundred_blows_other_on"
        elif re.fullmatch(r"^You begin to spin from one hundred blows\.\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ deftly manipulates the boxes lock and flips the tumblers\.$", line) is not None:
            return "spell_open_black_box_other_on"
        elif re.fullmatch(r"^You deftly manipulate the boxes lock and flip the tumblers\.$", line) is not None:
            return "spell_open_black_box_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is adorned in an aura of radiant grace\.$", line) is not None:
            return "spell_overwhelming_splendor_other_on"
        elif re.fullmatch(r"^You are adorned in an aura of radiant grace\.$", line) is not None:
            return "spell_overwhelming_splendor_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a brief lupine aura\.$", line) is not None:
            return "spell_spirit_of_wolf_other_on"
            # return "spell_pack_spirit_other_on"
        elif re.fullmatch(r"^You feel the spirit of wolf enter you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ pulses with a blue-green aura\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ has the fear of life put in them\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are covered in illusionary armor\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are covered in illusionary chainmail armor\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are covered in illusionary leather armor\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are covered in illusionary platemail armor\.\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is encased within a pillar of frost\.$", line) is not None:
            return "spell_pillar_of_frost_other_on"
        elif re.fullmatch(r"^You are encased within a pillar of frost\.$", line) is not None:
            return "spell_pillar_of_frost_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is immolated in a pillar of raging lightning\.$", line) is not None:
            return "spell_pillar_of_lightning_other_on"
        elif re.fullmatch(r"^You are immolated in a pillar of raging lightning\.$", line) is not None:
            return "spell_pillar_of_lightning_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s jaws emit a foul stench\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is sheathed in ice crystals\.$", line) is not None:
            return "spell_pogonip_other_on"
        elif re.fullmatch(r"^You are sheathed in ice crystals\.$", line) is not None:
            return "spell_pogonip_you_on"
        elif re.fullmatch(r"^A green mist seeps in to your skin\.$", line) is not None:
            return "spell_poison_breath_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ has been injected with a chilling poison\.$", line) is not None:
            return "spell_poisonous_chill_other_on"
        elif re.fullmatch(r"^You have been injected with a chilling poison\.$", line) is not None:
            return "spell_poisonous_chill_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ writhes in agony s the spirits of the forest attack\.$", line) is not None:
            return "spell_power_of_the_forests_other_on"
        elif re.fullmatch(r"^Your body writhes in agony as the spirits of the forest attack\.$", line) is not None:
            return "spell_power_of_the_forests_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin erupts in purulent pock marks\.$", line) is not None:
            return "spell_pox_of_bertoxxulous_other_on"
        elif re.fullmatch(r"^Your skin erupts in purulent pock marks\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ shines with a primal aura\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is washed in a vibrant blue light\.$", line) is not None:
            return "spell_prime_healers_blessing_other_on"
        elif re.fullmatch(r"^You are washed in a vibrant blue light\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is consumed by lightning\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is covered in a protective aura\.$", line) is not None:
            return "spell_protect_other_on"
        elif re.fullmatch(r"^A protective aura settles over you\.$", line) is not None:
            return "spell_protect_you_on"
        elif re.fullmatch(r"^You feel an aura of vigorous protection surround you\.$", line) is not None:
            return "spell_purifying_rhythms_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s flesh begins to liquefy\.$", line) is not None:
            ...
            # return "spell_rodricks_gift_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ has been surrounded by the Quivering Veil of Xarn\.$", line) is not None:
            return "spell_quivering_veil_of_xarn_other_on"
        elif re.fullmatch(r"^You are surrounded by the Quivering Veil of Xarn\.$", line) is not None:
            return "spell_quivering_veil_of_xarn_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s face takes on a radiant visage\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ flies into a chaotic rage\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is guided by the Rage of Tallon\.$", line) is not None:
            return "spell_rage_of_tallon_other_on"
        elif re.fullmatch(r"^The Rage of Tallon guides your sword\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is weakened by the Rage of Vallon\.$", line) is not None:
            return "spell_rage_of_vallon_other_on"
        elif re.fullmatch(r"^Your mind is crushed by the Rage of Vallon\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s eyes go wide with horror\.$", line) is not None:
            return "spell_rage_of_zek_other_on"
        elif re.fullmatch(r"^The chaos of war consumes your soul\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ swoons in raptured bliss\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s enchantments begin to fade\.$", line) is not None:
            return "spell_recant_magic_other_on"
        elif re.fullmatch(r"^You feel your enchantments being stripped away\.$", line) is not None:
            return "spell_recant_magic_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s body hums with a sapping vitality\.$", line) is not None:
            return "spell_reckless_health_other_on"
        elif re.fullmatch(r"^Your body surges with a sapping vitality\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s muscles bulge with reckless strength\.$", line) is not None:
            return "spell_reckless_strength_other_on"
        elif re.fullmatch(r"^Your muscles erupt with reckless strength\.\.$", line) is not None:
            return "spell_reckless_strength_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ has been struck by the judgement of the gods\.$", line) is not None:
            return "spell_reckoning_other_on"
        elif re.fullmatch(r"^You have been struck down by the judgement of the gods\.$", line) is not None:
            return "spell_reckoning_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ disperses\.$", line) is not None:
            return "spell_reclaim_energy_other_on"
        elif re.fullmatch(r"^You reclaim energy from your pet\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ screams as a magic force rends their flesh\.$", line) is not None:
            return "spell_rend_other_on"
        elif re.fullmatch(r"^You scream as a magic force rends the skin from your body\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is resistant to disease\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ has been struck by the wrath of the gods\.$", line) is not None:
            return "spell_retribution_other_on"
        elif re.fullmatch(r"^You have been struck by the wrath of the gods\.$", line) is not None:
            return "spell_retribution_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is frozen by the retribution of Al'Kabor\.$", line) is not None:
            return "spell_retribution_of_alkabor_other_on"
        elif re.fullmatch(r"^You are frozen by the retribution of Al'Kabor\.$", line) is not None:
            return "spell_retribution_of_alkabor_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s body shines with riotous health\.$", line) is not None:
            return "spell_riotous_health_other_on"
        elif re.fullmatch(r"^Your body shines with riotous health\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a shimmer of runes\.$", line) is not None:
        ...
        elif re.fullmatch(r"^A light shimmer of runes surround you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^A dark shimmer of runes surround you\.$", line) is not None:
            return "spell_rune_iii_you_on"
        elif re.fullmatch(r"^A coat of shimmering runes surround you\.$", line) is not None:
            return "spell_rune_iv_you_on"
            # return "spell_rune_v_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is filled with a savage spirit\.$", line) is not None:
            return "spell_savage_spirit_other_on"
        elif re.fullmatch(r"^You are filled with a savage spirit\.$", line) is not None:
            return "spell_savage_spirit_you_on"
        elif re.fullmatch(r"^The spirit departs leaving you drained\.$", line) is not None:
            return "spell_savage_spirit_you_off"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a dark lupine aura\.$", line) is not None:
            return "spell_scale_of_wolf_other_on"
            # return "spell_spirit_of_scale_other_on"
        elif re.fullmatch(r"^You feel the spirit-scale of wolf enter you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ launches a spray of scarabs\.$", line) is not None:
            return "spell_scarab_storm_other_cast"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is burned by the Scars of Sigil\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a dark haze\.$", line) is not None:
            return "spell_scent_of_darkness_other_on"
            # return "spell_scent_of_terris_other_on"
        elif re.fullmatch(r"^You smell the faint scent of darkness\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a dull haze\.$", line) is not None:
            return "spell_scent_of_dusk_other_on"
        elif re.fullmatch(r"^You smell the faint scent of dusk\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a dim haze\.$", line) is not None:
            return "spell_scent_of_shadow_other_on"
        elif re.fullmatch(r"^You smell the faint scent of shadow\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You smell the faint scent of Terris\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is covered in scintillating flames\.$", line) is not None:
            return "spell_scintillation_other_on"
        elif re.fullmatch(r"^Scintillating flames race across your body\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ lets loose a mighty yaulp\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You feel a surge of strength as you let forth a loud scream\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is burnt by the Seeking Flame of Seukor\.$", line) is not None:
            return "spell_seeking_flame_of_seukor_other_on"
        elif re.fullmatch(r"^You are burnt by the Seeking Flame of Seukor\.$", line) is not None:
            return "spell_seeking_flame_of_seukor_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s body pulses with fury\.$", line) is not None:
            return "spell_seething_fury_other_on"
        elif re.fullmatch(r"^You feel your body filled by fury\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is bound by silver strands of music\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is bound in chords of music\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by chains of music\.$", line) is not None:
            return "spell_selos_consonant_chain_other_on"
        elif re.fullmatch(r"^Your voice binds chords into chains\.$", line) is not None:
        ...
        elif re.fullmatch(r"^Your feet blur as they leave the ground\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You sense that you are being watched\.$", line) is not None:
            return "spell_sentinel_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s image fades around the edges\.$", line) is not None:
            return "spell_shade_other_on"
        elif re.fullmatch(r"^Your image fades.$", line) is not None:
            return "spell_shade_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s image fades into the shadows\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a vortex of shadows\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin is rent by shards\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a thorny barrier of blades\.$", line) is not None:
            return "spell_shield_of_blades_other_on"
        elif re.fullmatch(r"^You are surrounded by a thorny barrier of blades\.\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a shield of song\.$", line) is not None:
            return "spell_shield_of_song_other_on"
        elif re.fullmatch(r"^You are surrounded by a shield of song\.$", line) is not None:
            return "spell_shield_of_song_you_on"
        elif re.fullmatch(r"^Your shielding fades\.\.$", line) is not None:
            return "spell_shield_of_the_magi_you_off"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin is covered in a mystic glow\.$", line) is not None:
            return "spell_shieldskin_other_on"
        elif re.fullmatch(r"^A mystic force shields your skin\.$", line) is not None:
            return "spell_shieldskin_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a shifting spirit shield\.$", line) is not None:
            return "spell_shifting_shield_other_on"
        elif re.fullmatch(r"^A shifting spirit shield surrounds you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ convulses as lightning arcs through them\.$", line) is not None:
            return "spell_shock_of_lightning_other_on"
        elif re.fullmatch(r"^You convulse as lightning arcs through you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You feel your skin burn as poison seeps through your skin\.$", line) is not None:
            return "spell_shock_of_poison_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is lacerated by deadly steel\.$", line) is not None:
            return "spell_shock_of_steel_other_on"
        elif re.fullmatch(r"^You have been lacerated by deadly steel\.$", line) is not None:
            return "spell_shock_of_steel_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is blasted by static winds\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s hands are covered by a nimbus of deathly darkness\.$", line) is not None:
            return "spell_shroud_of_death_other_on"
        elif re.fullmatch(r"^A nimbus of deathly darkness covers your hands\.$", line) is not None:
            return "spell_shroud_of_death_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is washed over by a wave of shadows\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is engulfed in a seething mass of darkness\.$", line) is not None:
            return "spell_shroud_of_pain_other_on"
        elif re.fullmatch(r"^A seething mass of darkness engulfs you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a spirit shroud\.$", line) is not None:
            return "spell_shroud_of_the_spirits_other_on"
        elif re.fullmatch(r"^A protective spirit shroud cloaks you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s body is surrounded by a nimbus of deathly darkness\.$", line) is not None:
            return "spell_shroud_of_undeath_other_on"
        elif re.fullmatch(r"^A nimbus of deathly darkness covers your body\.$", line) is not None:
            return "spell_shroud_of_undeath_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin takes on a silvery hue\.$", line) is not None:
            return "spell_silver_skin_other_on"
        elif re.fullmatch(r"^Your skin takes on a silvery hue\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin blisters as lava rains down from above\.$", line) is not None:
            return "spell_sirocco_other_on"
        elif re.fullmatch(r"^Your skin blisters as lava rains down from above\.$", line) is not None:
            return "spell_sirocco_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin turns hard as diamond\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin shimmers with divine power\.$", line) is not None:
            return "spell_skin_like_nature_other_on"
        elif re.fullmatch(r"^Your skin shimmers with divine power\.$", line) is not None:
            return "spell_skin_like_nature_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin turns hard as stone\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin turns hard as steel\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin turns hard as wood\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin turns to shadow\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is drenched with skunk musk\.$", line) is not None:
            return "spell_skunkspray_other_on"
        elif re.fullmatch(r"^You have been sprayed with skunk musk\.$", line) is not None:
        ...
        elif re.fullmatch(r"^Your body is covered in a fine mist of slime\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You have been smitten\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are captivated by the bewitching tune\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are captivated by the haunting tune\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ flees in nocturnal terror\.$", line) is not None:
        ...
        elif re.fullmatch(r"^The fury of the deep see fills your arms\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You feel your soul being consumed\.$", line) is not None:
            return "spell_soul_devour_you_on"
        elif re.fullmatch(r"^You feel your soul draining away\.$", line) is not None:
            return "spell_soul_leech_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s body pulses with the spirit of the Shissar\.$", line) is not None:
            return "spell_speed_of_the_shissar_other_on"
        elif re.fullmatch(r"^Your body pulses with the spirit of the Shissar\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is coated in translucent armor\.$", line) is not None:
            return "spell_spirit_armor_other_on"
        elif re.fullmatch(r"^Translucent armor gathers around you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a brief ursine aura\.$", line) is not None:
            return "spell_spirit_of_bear_other_on"
        elif re.fullmatch(r"^You feel the spirit of bear enter you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a brief feline aura\.$", line) is not None:
            return "spell_spirit_of_cat_other_on"
            # return "spell_spirit_of_cheetah_other_on"
        elif re.fullmatch(r"^You feel the spirit of cat enter you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You feel the spirit of cheetah enter you\.\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a brief simian aura\.$", line) is not None:
            return "spell_spirit_of_monkey_other_on"
        elif re.fullmatch(r"^You feel the spirit of monkey enter you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a brief bovine aura\.$", line) is not None:
            return "spell_spirit_of_ox_other_on"
        elif re.fullmatch(r"^You feel the spirit of ox enter you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a brief serpentine aura\.$", line) is not None:
            return "spell_spirit_of_snake_other_on"
        elif re.fullmatch(r"^You feel the spirit of snake enter you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ summons a howling spirit.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s body begins to splurt\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s feet stick to the ground as they begin to regenerate\.$", line) is not None:
            return "spell_stalwart_regeneration_other_on"
        elif re.fullmatch(r"^Your feet anchor to the ground as you begin to regenerate\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You feel the glare of the heavens\.$", line) is not None:
        ...
        elif re.fullmatch(r"^A globe of stars form within your hands\.$", line) is not None:
            return "spell_starshine_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is consumed in a magic pulse\.$", line) is not None:
            return "spell_static_other_on"
        elif re.fullmatch(r"^You are consumed in a magic pulse\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s armor cranks harder as steam floods through it\.$", line) is not None:
            return "spell_steam_overload_other_on"
        elif re.fullmatch(r"^Your armor cranks harder as steam floods through it\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin looks like steel\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is encased in solid stone\.$", line) is not None:
            return "spell_stone_breath_other_on"
        elif re.fullmatch(r"^Your body is encased in solid stone\!$", line) is not None:
            return "spell_stone_breath_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s body burns as the acid hits them\.$", line) is not None:
            return "spell_stream_of_acid_other_on"
        elif re.fullmatch(r"^Your body burns as the acid hits you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^Nature\'s strength flows through your muscles\.$", line) is not None:
        ...
        elif re.fullmatch(r"^Your body is electrified as the lightning strikes you\.$", line) is not None:
            return "spell_strike_of_thunder_you_on"
            # return "spell_thunder_blast_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ sets loose a torrent of lightning\.$", line) is not None:
            return "spell_strike_of_thunder_other_cast"
            # return "spell_thunder_blast_other_cast"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ staggers with intense pain\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ reels from a stunning blow\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ summons a companion to their side\.$", line) is not None:
            return "spell_summon_companion_other_on"
        elif re.fullmatch(r"^You summon your companion to your side\.$", line) is not None:
            return "spell_summon_companion_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ summons a swirling orb of elements\.$", line) is not None:
            return "spell_summon_orb_other_on"
        elif re.fullmatch(r"^A swirling orb of elements forms in your hand\.$", line) is not None:
            return "spell_summon_orb_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s hands pulse with soft light\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is blinded by a sunbeam\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is consumed by the flames of the sun\.$", line) is not None:
            return "spell_sunstrike_other_on"
        elif re.fullmatch(r"^Your body is consumed by the flames of the sun\.$", line) is not None:
            return "spell_sunstrike_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is engulfed by a swarm of deadly insects\.$", line) is not None:
            return "spell_swarm_of_retribution_other_on"
        elif re.fullmatch(r"^You feel the pain of a million stings\.\.$", line) is not None:
            return "spell_swarm_of_retribution_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is engulfed by a swarm of insects\.$", line) is not None:
            return "spell_swarming_pain_other_on"
        elif re.fullmatch(r"^You feel the pain unbearable pain of a thousand stings\.$", line) is not None:
            return "spell_swarming_pain_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a warm aura\.$", line) is not None:
            return "spell_sympathetic_aura_other_on"
        elif re.fullmatch(r"^You feel a warm aura surround you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^Your body spasms as poison runs through you\.$", line) is not None:
            return "spell_system_shock_i_you_on"
        elif re.fullmatch(r"^Your body spasms as poison spreads through you\.$", line) is not None:
            return "spell_system_shock_ii_you_on"
            # return "spell_system_shock_iii_you_on"
            # return "spell_system_shock_iv_you_on"
        elif re.fullmatch(r"^Your body spasms as poison spreads through your body\.$", line) is not None:
            return "spell_system_shock_v_you_on"
        elif re.fullmatch(r"^You feel a static pulse wash through you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ intones the Unspoken Word\.$", line) is not None:
            return "spell_the_unspoken_word_you_off"
        elif re.fullmatch(r"^You feel your mental energies drain away\.$", line) is not None:
            return "spell_theft_of_thought_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin sprouts thistles\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ has been struck by a Thunder Bolt\.$", line) is not None:
            return "spell_thunder_strike_other_on"
        elif re.fullmatch(r"^You have been thunder struck\.$", line) is not None:
            return "spell_thunder_strike_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ has been thunder stunned\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+  is stunned by a clap of thunder\.$", line) is not None:
            return "spell_thunderclap_other_on"
        elif re.fullmatch(r"^A clap of thunder fills your ears\.$", line) is not None:
            return "spell_thunderclap_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is blasted by a jet of acid\.$", line) is not None:
            return "spell_torbas_acid_blast_other_on"
        elif re.fullmatch(r"^A blast of acid eats at your skin\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ screams from the Torment of Argli\.$", line) is not None:
            return "spell_torment_of_argli_other_on"
        elif re.fullmatch(r"^Your thoughts muddle from the Torment of Argli\.$", line) is not None:
            return "spell_torment_of_argli_you_on"
        elif re.fullmatch(r"^Your torment has ended\.$", line) is not None:
            return "spell_torment_of_argli_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is gripped by shadows of fear and terror\.$", line) is not None:
            return "spell_torment_of_shadows_other_on"
        elif re.fullmatch(r"^Your mind is filled by fear and terror from the shadows\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ falls into a state of torpor\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin steams and melts\.$", line) is not None:
            return "spell_torrent_of_poison_other_on"
        elif re.fullmatch(r"^Your skin steams and melts as poison rains down on you\.$", line) is not None:
            return "spell_torrent_of_poison_you_on"
        elif re.fullmatch(r"^Your lifeforce drains at the Touch of Night\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ begins to walk faster\.\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is filled with trepidation\.$", line) is not None:
            return "spell_trepidation_other_on"
        elif re.fullmatch(r"^Your mind fills with trepidation\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is crushed by a wall of water\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ staggers under the weight of divine words\.$", line) is not None:
            return "spell_turning_of_the_unnatural_other_on"
        elif re.fullmatch(r"^You stagger as the light of divine words enter your mind\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s image fades into the umbra\.$", line) is not None:
            return "spell_umbra_other_on"
        elif re.fullmatch(r"^Your image fades into the umbra\.$", line) is not None:
            return "spell_umbra_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ exudes an aura of massive charisma\.$", line) is not None:
            return "spell_unfailing_reverence_other_on"
        elif re.fullmatch(r"^People look at you with unfailing reverence\.$", line) is not None:
            return "spell_unfailing_reverence_you_on"
        elif re.fullmatch(r"^The ground buckles and heaves beneath your feet\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is blasted by the Vengeance of Al\'Kabor\.$", line) is not None:
            return "spell_vengeance_of_alkabor_other_on"
        elif re.fullmatch(r"^You are blasted by the vengeance of Al\'Kabor\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is struck by a sudden force\.$", line) is not None:
            return "spell_verlekarnorms_disaster_other_on"
        elif re.fullmatch(r"^You are struck by a sudden force\.$", line) is not None:
            return "spell_verlekarnorms_disaster_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ staggers under the curse of Vexing Mordinia\.$", line) is not None:
            return "spell_vexing_mordinia_other_on"
        elif re.fullmatch(r"^Vexing Mordinia begins to drain your life away\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ experiences visions of grandeur\.$", line) is not None:
            return "spell_visions_of_grandeur_other_on"
        elif re.fullmatch(r"^You experience visions of grandeur\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You lose yourself in your rage and go berserk\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You forget what you were supposed to be\.$", line) is not None:
        ...
        elif re.fullmatch(r"^A blast of cold freezes your skin\.$", line) is not None:
            return "spell_wave_of_cold_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is singed by a wave of fire\.$", line) is not None:
            return "spell_wave_of_fire_other_on"
        elif re.fullmatch(r"^You are singed by a wave of fire\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ summons the power of elemental fire\.$", line) is not None:
            return "spell_wave_of_flame_other_cast"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is surrounded by a wave of healing\.$", line) is not None:
            return "spell_wave_of_healing_other_on"
        elif re.fullmatch(r"^A wave of healing washes over you\.$", line) is not None:
        ...
        elif re.fullmatch(r"^A blast of heat sears your flesh$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s face becomes twisted with fury\.$", line) is not None:
            return "spell_whirlwind_other_on"
        elif re.fullmatch(r"^Your instincts take over as you turn aside every attack\.$", line) is not None:
            return "spell_whirlwind_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s skin ignites as wildfire courses over them\.$", line) is not None:
            return "spell_wildfire_other_on"
        elif re.fullmatch(r"^Your skin ignites as wildfire courses over your body\.$", line) is not None:
            return "spell_wildfire_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ discorporates in a portal of wind\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+\'s body is rent by freezing winds\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ is engulfed in a swarm of deadly insects\.$", line) is not None:
            return "spell_winged_death_other_on"
        elif re.fullmatch(r"^You feel the pain of a million stings\.$", line) is not None:
            return "spell_winged_death_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ begins to move with wonderous rapidity\.$", line) is not None:
            return "spell_wonderous_rapidity_other_on"
        elif re.fullmatch(r"^You begin to move with wonderous rapidity\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You are wracked with pain\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ feels the touch of Redemption\.$", line) is not None:
            return "spell_word_of_redemption:_other_on"
        elif re.fullmatch(r"^You feel the touch of Redemption\.$", line) is not None:
        ...
        elif re.fullmatch(r"^[a-zA-Z`\s]+ has been struck down by wrath\.$", line) is not None:
            return "spell_wrath_other_on"
        elif re.fullmatch(r"^You have been struck down by wrath\.$", line) is not None:
            return "spell_wrath_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ has been gripped by nature's wrath\.$", line) is not None:
            return "spell_wrath_of_nature_other_on"
        elif re.fullmatch(r"^You are gripped by nature's wrath\.$", line) is not None:
        ...
        elif re.fullmatch(r"^You feel a surge of strength as you let forth a mighty yaulp\.$", line) is not None:
            return "spell_yaulp_you_on"
            # return "spell_yaulp_ii_you_on"
            # return "spell_yaulp_iii_you_on"
            # return "spell_yaulp_iv_you_on"
        elif re.fullmatch(r"^[a-zA-Z`\s]+ has been struck by the force of Ykesha\.$", line) is not None:
            return "spell_ykesha_other_on"
        elif re.fullmatch(r"^You have been struck by the force of Ykesha\.$", line) is not None:
