    ...
    try:
        ...
        if re.fullmatch(r"^You .+", line) is not None:
            if re.fullmatch(r"^You experience a quickening\.$", line) is not None:
                ...
                re.fullmatch(
                    r"^You stagger as spirits of frost slam against you\.$", line
                )
                is not None
            ):
                ...
                re.fullmatch(r"^You feel your lifeforce drain away\.$", line)
                is not None
            ):
                ...
                re.fullmatch(r"^You experience chaotic weightlessness\.$", line)
                is not None
            ):
                ...
                re.fullmatch(r"^You feel your life draining into your mind\.$", line)
                is not None
            ):
                ...
                re.fullmatch(r"^You have been struck by the wrath of the gods\.$", line)
                is not None
            ):
                ...
                re.fullmatch(
                    r"^You feel your skin burn as poison seeps through your skin\.$",
                    line,
                )
                is not None
            ):
                ...
                re.fullmatch(r"^You have been struck down by wrath\.$", line)
                is not None
            ):
        ...
        ### Spell Specific Your
            ...
            if re.fullmatch(r"^Your speed returns to normal\.$", line) is not None:
                ...
                re.fullmatch(r"^Your body aches as your mind clears\.$", line)
                is not None
            ):
        ...
        ## The
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+ vanishes amidst the sound of whirrs and clicks\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(r"^A massive force knocks you backwards\.$", line) is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+\'s eyes are covered by notes of solid music\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(r"^A mellifluous melody sweeps you away\.$", line) is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+ has been struck down by the wrath of nature\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+ is immolated in a pillar of raging lightning\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+ has been struck by the judgement of the gods\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(r"^A light shimmer of runes surround you\.$", line) is not None
        ):
            ...
            re.fullmatch(r"^A dark shimmer of runes surround you\.$", line) is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+ is surrounded by a thorny barrier of blades\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(r"^A nimbus of deathly darkness covers your hands\.$", line)
            is not None
        ):
            ...
            re.fullmatch(r"^A protective spirit shroud cloaks you\.$", line) is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+\'s skin blisters as lava rains down from above\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+\'s body pulses with the spirit of the Shissar\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+ has been protected by the Talisman of Jasinth\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+ has been protected by the Talisman of Shadoo\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+ staggers under the curse of Vexing Mordinia\.$", line
            )
            is not None
        ):
            ...
            re.fullmatch(
                r"^[a-zA-Z`\s]+\'s skin ignites as wildfire courses over them\.$", line
            )
            is not None
        ):
